...
def get_burrito_sales_outliers(array):
    ...
    # iqr = np.quantile(burrito_sales, .75) - np.quantile(burrito_sales, .25) # UNCOMMENT ME
    ...
    # upper_threshold = np.quantile(burrito_sales, .75) + (iqr * 1.5) # UNCOMMENT ME
